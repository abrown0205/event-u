...
function Events() {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(parseInt(endHour) + 12);        
        console.log("startHour" + startHour);
        console.log("endHour " + endHour);
        console.log("address " + address);
        console.log("end time: " + endTime);
        console.log("startTime: " + startTime);
        console.log("isDate" + !isDate(parseISO(startTime)))
        ...
        else if(endTime === null || !isDate(parseISO(endTime))) {
                    ...
                    <div>
                        ...
                        <form className="eventForm" onSubmit={handleSubmit} autoComplete="off">
                            ...
                            <label className="label" id="desc-label">Date:
                                <select className="time" id="date-month-select" onChange={(e) => setMonth(e.target.value)}>
                                ...
                                <select className="time" id="date-month-select" defaultValue="01" onChange={(e) => setDay(e.target.value)}>
                                ...
                                <select className="time" id="date-month-select" defaultValue="2021" onChange={(e) => setYear(e.target.value)}>
